...
let panier = 700 ;
let disc = panier-(panier*0.10)
if(panier>500){
    console.log("vous avez une réduction de 10% votre prix est : "+disc+ " MAD" )
    console.log("livraison gratuite");
}else if(panier>200){
    console.log("votre prix total est : "+panier+" MAD")
    console.log("livraison gratuite");
}else{
    console.log("le total est : "+panier+" MAD")
}